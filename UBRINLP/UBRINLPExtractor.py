...
# test = UBRINlpExtractor("城镇供热系统的运行维护管理应制定相应的管理制度、岗位责任制、安全操作规程、设施和设备维护保养手册及事故应急预案，并应定期进行修订。")
test = UBRINlpExtractor("管道共建各参建方应明确管道段落的起吃点、建设路由、管孔数、管孔规格、段长、人（手）孔设置、材料和工期安排。")
